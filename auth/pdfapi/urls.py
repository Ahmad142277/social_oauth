...
from .views import bs_pdf, bs_download_pdf, pl_pdf, pl_download_pdf, j_pdf, j_download_pdf, in_pdf, in_download_pdf
...
urlpatterns = [
    ...
    path('invoice_pdf/', in_pdf, name='invoice_pdf'),
    re_path(r'^in_pdf/(?P<file_path>.+)$', in_download_pdf, name='in_pdf'),
